...
from .resnet50_ror import get_resnet50_ror_encoder
...
def _unet( n_classes , encoder , l1_skip_conn=True,  input_height=256, input_width=256  ):
	...
	o = ( UpSampling2D( (1,1), data_format=IMAGE_ORDERING))(o)
	print("last**********************",o.shape)
	if l1_skip_conn:
	...
	print("-----------------------------------------------",o.shape)
	model = get_segmentation_model(img_input , o )
	plot_model(model, to_file='ror_new_unet.png')
...
def ror_unet( n_classes ,  input_height=256, input_width=256 , encoder_level=3):
	model =  _unet( n_classes , get_resnet50_ror_encoder ,  input_height=input_height, input_width=input_width  )  
	model.model_name = "ror_unet"
	return model
