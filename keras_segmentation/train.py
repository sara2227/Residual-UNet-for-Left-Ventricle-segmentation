...
#ye check_num ezafe kardam ke betunim taein konim vaznhaye kodum epoch estefade beshe vase predict,filehaye predict,cli_interface ham taghir dadam
# def find_latest_checkpoint( checkpoints_path,check_num ):
